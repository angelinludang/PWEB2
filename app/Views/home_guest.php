...
<header class="bg-primary text-white text-center py-5 mb-4">
    <div class="container">
        <h1 class="display-6 fw-bold">Selamat Datang di EDUCONNECT</h1>
        <p class="lead">Platform Open Course gratis untuk belajar dan berbagi pengetahuan!</p>
    </div>
</header>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-footer bg-white">
                            <a href="/login" class="btn btn-sm btn-outline-primary w-100 mt-2">Login untuk melihat</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
